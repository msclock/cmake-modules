...
if(NOT "${CMAKE_CXX_STANDARD}" STREQUAL "")
  if("${USE_CLANGTIDY_OPTIONS_DRIVER_MODE}" STREQUAL "cl")
    set(CLANG_TIDY_STANDARD_BY_DRIVER -extra-arg=/std:c++${CMAKE_CXX_STANDARD})
  else()
    set(CLANG_TIDY_STANDARD_BY_DRIVER -extra-arg=-std=c++${CMAKE_CXX_STANDARD})
  endif()

  list(APPEND CMAKE_CXX_CLANG_TIDY ${CLANG_TIDY_STANDARD_BY_DRIVER})
  unset(CLANG_TIDY_STANDARD_BY_DRIVER)
endif()
