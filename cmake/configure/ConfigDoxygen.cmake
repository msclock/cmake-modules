...
macro(configDoxygen)
  ...
  # normally produced when WARNINGS is set to YES. The default value is: NO.
  ...
  # this tag to YES in order to let doxygen match functions declarations and
  ...
  # Hungarian, Indonesian, Italian, Japanese, Japanese-en (Japanese with English
  # messages), Korean, Korean-en (Korean with English messages), Latvian,
  ...
  # *.h) to filter out the source-files in the directories. Note that for custom
  # extensions or not directly supported extensions you also need to set
  # EXTENSION_MAPPING for the extension otherwise the files are not read by
  # doxygen. Note the list of default checked file patterns might differ from
  # the list of default file extension mappings. If left blank the following
  # patterns are tested: *.c, *.cc, *.cxx, *.cpp, *.c++, *.java, *.ii, *.ixx,
  # *.ipp, *.i++, *.inl, *.idl, *.ddl, *.odl, *.h, *.hh, *.hxx, *.hpp, *.h++,
  # *.l, *.cs, *.d, *.php, *.php4, *.php5, *.phtml, *.inc, *.m, *.markdown,
  # *.md, *.mm, *.dox (to be provided as doxygen C comment), *.py, *.pyw, *.f90,
  # *.f95, *.f03, *.f08, *.f18, *.f, *.for, *.vhd, *.vhdl, *.ucf, *.qsf and
  # *.ice.
  ...
  # struct with name TypeT. When disabled the typedef will appear as a member of
  # a file, namespace, or class. And the struct will be named TypeS. This can
  ...
  # diagram (in HTML and LaTeX) for classes with base or super classes. Setting
  # the tag to NO turns the diagrams off. Note that this option also works with
  # HAVE_DOT disabled, but it is recommended to install and use dot, since it
  # yields more powerful graphs.
  ...
  # dependency graph for every global function or class method. Note that
  # enabling this option will significantly increase the time of a run. So in
  # most cases it will be better to enable caller graphs for selected functions
  ...
  # direct children of the root node in a graph is already larger than
